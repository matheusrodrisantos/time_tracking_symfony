 ...
 */
final class Version20241105130551 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, role_id, name, password, birth_date, postcode, status, code_erp, photo, hire_date, email, created_at, updated_at FROM "user"');
        ...
        $this->addSql('INSERT INTO "user" (id, role_id, name, password, birth_date, postcode, status, code_erp, photo, hire_date, email, created_at, updated_at) SELECT id, role_id, name, password, birth_date, postcode, status, code_erp, photo, hire_date, email, created_at, updated_at FROM __temp__user');
